...
from asmx.linter import ERRO, Problem, summary, validate
...
class TestDivisao(unittest.TestCase):
    ...
    def test_div_sem_preparar_rdx(self) -> None:
        src = "f:\n mov rax, 100\n mov rbx, 7\n div rbx\n ret"
    ...
    def test_div_preparado_nao_reclama(self) -> None:
        src = "f:\n xor rdx, rdx\n mov rax, 100\n mov rbx, 7\n div rbx\n ret"
        self.assertNotIn("DIV001", codes(src))

    def test_idiv_aceita_cqo(self) -> None:
        src = "f:\n mov rax, -100\n cqo\n mov rbx, 7\n idiv rbx\n ret"
        self.assertNotIn("DIV001", codes(src))

    def test_divisao_por_imediato(self) -> None:
        src = "f:\n xor rdx, rdx\n mov rax, 10\n div 0\n ret"
        c = codes(src)
...
class TestPilhaEAbi(unittest.TestCase):
    ...
    def test_push_com_pop_passa(self) -> None:
        src = "f:\n push rbx\n mov rax, 1\n pop rbx\n ret"
    ...
    def test_callee_saved_sem_salvar(self) -> None:
        src = "f:\n mov rbx, 10\n ret"
        self.assertIn("ABI002", codes(src))

    def test_shadow_space_no_windows(self) -> None:
        src = (
            "extern ExitProcess\nsection .text\nglobal main\nmain:\n"
            "  xor rcx, rcx\n  call ExitProcess\n  ret\n"
        )
    ...
    def test_shadow_space_presente_passa(self) -> None:
        src = (
            "extern ExitProcess\nsection .text\nglobal main\nmain:\n"
            "  sub rsp, 40\n  xor rcx, rcx\n  call ExitProcess\n  ret\n"
        )
...
class TestOperandos(unittest.TestCase):
    ...
    def test_valor_alto_demais(self) -> None:
        p = problems("f:\n mov al, 300\n ret", "IMM001")
        self.assertTrue(p)
        self.assertIn("8 bits", p[0].message)

    def test_valor_que_cabe_passa(self) -> None:
        self.assertNotIn("IMM001", codes("f:\n mov al, 200\n ret"))

    def test_valor_enorme_em_registrador_grande(self) -> None:
        self.assertIn("IMM001", codes("f:\n mov eax, 0x1FFFFFFFFF\n ret"))

    def test_tamanho_ambiguo_em_memoria(self) -> None:
        self.assertIn(
            "MEM001", codes("section .bss\nx resb 8\nsection .text\nf:\n mov [x], 1\n ret")
        )

    def test_tamanho_explicito_passa(self) -> None:
        self.assertNotIn(
            "MEM001", codes("section .bss\nx resb 8\nsection .text\nf:\n mov qword [x], 1\n ret")
        )
...
class TestSyscallsESecoes(unittest.TestCase):
    ...
    def test_rcx_apos_syscall(self) -> None:
        src = (
            "global _start\nsection .text\n_start:\n mov rax, 1\n syscall\n"
            " mov rbx, rcx\n mov rax, 60\n syscall\n"
        )
...
class TestConjunto(unittest.TestCase):
    ...
    def test_exemplo_limpo_nao_tem_erros(self) -> None:
    ...
    def test_exemplos_bons_sem_erro(self) -> None:
    ...
    def test_exemplo_quebrado_acusa_varios_problemas(self) -> None:
    ...
    def test_validacao_nao_quebra_com_lixo(self) -> None:
        for src in ("", "   ", ";;;;", "mov\n\n\n", "section", '"', "[[[", "f:"):
