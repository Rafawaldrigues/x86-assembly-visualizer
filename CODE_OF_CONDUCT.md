...
responsável pela aplicação, via contato **conduta@example.com**. Todas as
reclamações serão revisadas e investigadas imediatamente e de maneira justa.
...
proibidas as interações públicas ou privadas com as pessoas envolvidas, incluindo
interações não solicitadas com as pessoas que estiverem aplicando o Código de
Conduta. A violação destes termos pode resultar em um banimento permanente.
